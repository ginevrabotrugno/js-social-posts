...
posts.forEach(element => {
    ...
    const authorImage = element.author.image ? `<img class="profile-pic" src="${element.author.image}" alt="${element.author.name}">` : 
    `<div class="profile-pic-default"><span>${getInitials(element.author.name)}</span></div>`;

    // per ogni oggetto dell'array creo l'elemento html
    let post = 
        `
        <div class="post">
        ...
        // inserisco l'elemento creato in html
